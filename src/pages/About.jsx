...
const stats = [
  ...
  { value: "1 Million+", label: "Messages & Calls Processing Per Month" },
  { value: "400+", label: "Chatbots" },
];
  ...
  return (
    <>
      ...
      `}</style>
        ...
        {/* ===================== HERO SECTION ===================== */}
        <section className="px-2 md:px-2 py-2 md:py-14">
          <div className="max-w-8xl mx-5  grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="w-full">
              <img
                ...
                className="w-full h-[380px] md:h-[430px] object-cover rounded-2xl shadow-lg"
              />
            </div>
          </div>
        </section>
        ...
        {/* ===================== STATS SECTION ===================== */}
        <section className="px-2 md:px-2 py-19">
          <div className="max-w-8xl mx-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="border-l border-gray-300 pl-13 first:border-l-0 first:pl-0 lg:first:border-l-0"
              >
                <p className="text-3xl md:text-5xl font-semibold text-[#857a18]">
                  {stat.value}
                </p>
                <p className="text-gray-800 mt-3 text-[19px]">{stat.label}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* ===================== QUOTE / CEO SECTION ===================== */}
        <section className="bg-blue-50 px-2 md:px-6 py-6 md:py-14">
          <div className="max-w-8xl mx-1">
            ...
            <p className="font-semibold text-[#857a18] mb-2">
              Hasan Shaikh, CEO
            </p>
            <img
              src={about2}
        ...
        {/* ===================== AWARDS SECTION ===================== */}
        <section className="px-2 md:px-4 py-5 md:py-14">
          <div className="max-w-8xl mx-1">
            <span className="inline-block bg-blue-50 text-[#857a18] text-sm font-semibold px-4 py-1.5 rounded-md mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {awards.map((award) => (
                ...
                >
                  <p className="text-xl font-semibold text-[#857a18] mb-6">
                    {award.year}
                  </p>
                  <img
                    src={about3}
                  ...
                  <button className="mt-6 w-full h-2 bg-[#857a18] rounded-full opacity-90 hover:opacity-100 transition-opacity" />
                </div>
              ))}
            </div>
          </div>
        ...
        <section
          className="relative px-2 md:px-6 py-20 md:py-22 text-white overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="relative max-w-7xl mx-15">
            <div className="text-center mb-20 fade-in-up">
              ...
              <div className="mt-6 mx-auto h-[3px] w-24 rounded-full bg-gradient-to-r from-[#857a18] to-yellow-300" />
            </div>
              ...
              <div className="relative flex justify-between items-center">
                {milestones.map((milestone, idx) => (
                  ...
                  >
                    ...
                    {/* Dot on the line */}
                    <span className="relative z-10 w-5 h-5 rounded-full bg-white border-4 border-[#857a18] pulse-dot" />

                    {/* Year badge */}
                    <span className="mt-4 bg-gradient-to-r from-[#857a18] to-[#857a18] text-white text-sm font-semibold px-4 py-1.5 rounded-full shadow-lg shadow-[#307eba]/30">
                      {milestone.year}
                    </span>
            ...
            <div className="md:hidden space-y-6">
              {milestones.map((milestone, idx) => (
                ...
                >
                  <span className="absolute -left-1.5 top-6 w-4 h-4 rounded-full bg-[#857a18] border-2 border-white pulse-dot" />
                  <span className="inline-block bg-gradient-to-r from-[#857a18] to-[#857a18] text-white text-sm font-semibold px-4 py-1.5 rounded-full mb-3">
                    {milestone.year}
                  </span>
                  <ul className="space-y-2">
                    {milestone.points.map((point, i) => (
        ...
        <section className="w-[90%] mx-auto my-16 rounded-3xl overflow-hidden border border-gray-200 bg-blue-50 shadow-lg">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
            ...
            <div className="p-8 md:p-16">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-3 px-6 py-3 rounded-lg bg-[#857a18] text-white font-semibold hover:bg-[#070e37] transition-all duration-300"
              >
        ...
        <section className="px-2 md:px-6 py-10 md:py-18 overflow-hidden">
          <div className="max-w-8xl mx-5">
            <span className="inline-block bg-blue-50 text-[#857a18] text-sm font-semibold px-4 py-1.5 rounded-md mb-4 uppercase tracking-wide">
