    ...
    return (
        <section className="relative overflow-hidden py-16 bg-white">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div
                    className="absolute -top-52 -left-40 w-[900px] h-[900px] rounded-full blur-[180px]"
                    style={{ background: `${NAVY}26`, animation: "aurora1 15s ease-in-out infinite" }}
                />
                <div
                    className="absolute top-0 right-0 w-[700px] h-[700px] rounded-full blur-[180px]"
                    style={{ background: `${GOLD}26`, animation: "aurora2 18s ease-in-out infinite" }}
                />
                <div
                    className="absolute bottom-0 left-1/3 w-[800px] h-[800px] rounded-full blur-[180px]"
                    style={{ background: `${NAVY}1f`, animation: "aurora3 20s ease-in-out infinite" }}
                />
            </div>
                ...
                {[...Array(30)].map((_, i) => (
                    <div
                        ...
                        style={{
                            ...
                            top: `${Math.random() * 100}%`,
                            background: i % 2 === 0 ? `${NAVY}33` : `${GOLD}33`,
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden">
                ...
                <svg
                    ...
                    viewBox="0 0 1440 320"
                    preserveAspectRatio="none"
                    style={{ animation: "waveMove2 38s linear infinite", opacity: 0.1 }}
                >
                    <path
                        fill={GOLD}
            ...
            <div className="relative z-20 text-center mb-12 px-4">
                <span
                    className="inline-flex items-center px-5 py-2 rounded-full border backdrop-blur-xl text-sm font-semibold shadow-sm"
                    style={{ background: `${NAVY}0d`, borderColor: `${NAVY}33`, color: NAVY }}
                >
                    Integrations
                </span>

                <h2 className="mt-5 text-4xl md:text-5xl font-black leading-tight">
                    <span style={{ color: NAVY }}>Connect Every</span>
                    <br />
                    <span
                        className="bg-clip-text text-transparent"
                        style={{ backgroundImage: `linear-gradient(90deg, ${NAVY}, ${GOLD})` }}
                    >
                        Business Tool
                    </span>
                </h2>
            ...
            <div className="relative z-20">
                ...
                "
                                style={{
                                    borderColor: `${NAVY}1a`,
                                    boxShadow: "0 10px 50px rgba(26,28,93,0.08)",
                                }}
                                onMouseEnter={(e) => {
                                    e.currentTarget.style.borderColor = `${GOLD}80`;
                                    e.currentTarget.style.boxShadow = `0 25px 70px rgba(140,122,43,0.2)`;
                                    e.currentTarget.style.transform = "translateY(-16px)";
                                }}
                                onMouseLeave={(e) => {
                                    e.currentTarget.style.borderColor = `${NAVY}1a`;
                                    e.currentTarget.style.boxShadow = "0 10px 50px rgba(26,28,93,0.08)";
                            ...
                            >
                                ...
                                <div
                                    ...
                                    style={{
                                        background: `linear-gradient(135deg, ${NAVY}0d, ${GOLD}0d)`,
                                    }}
                                />
                  ...
                  "
                                ...
                                <div className="relative z-10 h-full flex flex-col items-center text-center px-5 py-5">
                                    {/* Logo */}
                                    <div
                                        className="w-26 h-26 rounded-2xl flex items-center justify-center mb-4 transition-all duration-700"
                                        style={{ boxShadow: `0 0 30px ${NAVY}14` }}
                                    >
                                        <img
                                            src={item.img}
                                            alt={item.name}
